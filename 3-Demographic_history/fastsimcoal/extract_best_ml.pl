# extract_best_ml.pl retrieves the maximum likelihood values of all the independent fastsimcoal runs per model in a table and extracts the key summary files of the best run per model in a new directory

# Use: perl extract_best_ml.pl (0)number_of_models (1)number_of_independent_runs_per_model (2)root_name_of_files
